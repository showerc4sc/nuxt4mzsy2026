<template>
  <div>
    <!-- 滚动进度指示器 -->
    <div class="scroll-progress fixed top-0 left-0 h-1 bg-gradient-to-r from-eco-500 to-eco-600 z-[55] transition-all duration-300"></div>

    <!-- 鼠标跟随效果 -->
    <div class="pointer-events-none fixed inset-0 z-[40] overflow-hidden">
      <div
        class="absolute w-96 h-96 rounded-full bg-eco-500/10 blur-3xl transition-transform duration-300 ease-out"
        :style="{
    ...
    <!-- 鼠标跟随效果 -->
    <div class="pointer-events-none fixed inset-0 z-[40] overflow-hidden">
      <div class="mouse-follow absolute top-1/4 left-1/4 w-64 h-64 bg-eco-500/10 rounded-full blur-3xl" data-speed="0.02" data-max-distance="30"></div>
      <div class="mouse-follow absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl" data-speed="0.03" data-max-distance="40"></div>
    </div>
      ...
      <div class="relative h-full" :style="{ transform: `translateY(${getParallaxOffset(0.3)}px)`, height: '100vh' }">
        <ClientOnly>
          <div class="flex h-full" :style="{ transform: `translateX(-${heroSlide * 100}%)`, transition: 'transform 1.2s cubic-bezier(0.4, 0, 0.2, 1)', height: '100vh' }" v-if="isClientInitialized">
            ...
            <div class="w-full flex-shrink-0 relative">
              ...
              <div class="absolute inset-0 overflow-hidden">
                <video
                  ...
                  playsinline
                >
                  <source src="https://www.lutongls.com/uploads/media/20240726/20241127.webm" type="video/webm">
                </video>
              ...
              <div class="relative z-20 h-full flex items-center justify-center">
                <div class="text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto" :class="heroSlide === 0 ? 'animate-fade-in-up' : 'opacity-0'">
                  <div class="mb-8">
                  ...
                  <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <NuxtLink
                      to="/products"
                      class="group relative px-10 py-4 bg-white text-eco-600 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">了解产品</span>
                      <div class="absolute inset-0 bg-gradient-to-r from-eco-50 to-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                    <NuxtLink
                      to="/contact"
                      class="group relative px-10 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-eco-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">联系我们</span>
                      <div class="absolute inset-0 bg-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                  </div>
                </div>
              </div>
            ...
            <!-- 轮播项 2: 甲醇新能源 -->
            <div class="w-full flex-shrink-0 relative">
              <div class="absolute inset-0 bg-cover bg-center scale-105" style="background-image: url('https://picsum.photos/seed/power-equipment-methanol/1920/1080.jpg')">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-800/85 to-blue-600/75 z-10"></div>
              </div>

              <!-- 内容 -->
              <div class="relative z-20 h-full flex items-center justify-center">
                <div class="text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto" :class="heroSlide === 1 ? 'animate-fade-in-up' : 'opacity-0'">
                  <div class="mb-8">
                    ...
                    <div class="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white text-sm font-medium">
                      核心技术
                    </div>
                  </div>
                  ...
                  <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <NuxtLink
                      to="/products"
                      class="group relative px-10 py-4 bg-white text-blue-600 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">查看产品</span>
                      <div class="absolute inset-0 bg-gradient-to-r from-blue-50 to-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                    <NuxtLink
                      to="/contact"
                      class="group relative px-10 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">技术咨询</span>
                      <div class="absolute inset-0 bg-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                  </div>
                </div>
            ...
            <!-- 轮播项 3: 风能技术 -->
            <div class="w-full flex-shrink-0 relative">
              <div class="absolute inset-0 bg-cover bg-center scale-105" style="background-image: url('https://picsum.photos/seed/wind-turbine-power/1920/1080.jpg')">
                <div class="absolute inset-0 bg-gradient-to-r from-teal-800/85 to-teal-600/75 z-10"></div>
              </div>

              <!-- 内容 -->
              <div class="relative z-20 h-full flex items-center justify-center">
                <div class="text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto" :class="heroSlide === 2 ? 'animate-fade-in-up' : 'opacity-0'">
                  <div class="mb-8">
                    <div class="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl">
                  ...
                  <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <NuxtLink
                      to="/products"
                      class="group relative px-10 py-4 bg-white text-teal-600 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">查看产品</span>
                      <div class="absolute inset-0 bg-gradient-to-r from-teal-50 to-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                    <NuxtLink
                      to="/contact"
                      class="group relative px-10 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-teal-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">解决方案</span>
                      <div class="absolute inset-0 bg-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                  </div>
                </div>
            ...
            <!-- 轮播项 4: 能源储存 -->
            <div class="w-full flex-shrink-0 relative">
              <div class="absolute inset-0 bg-cover bg-center scale-105" style="background-image: url('https://picsum.photos/seed/power-storage-equipment/1920/1080.jpg')">
                <div class="absolute inset-0 bg-gradient-to-r from-purple-800/85 to-purple-600/75 z-10"></div>
              </div>

              <!-- 内容 -->
              <div class="relative z-20 h-full flex items-center justify-center">
                <div class="text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto" :class="heroSlide === 3 ? 'animate-fade-in-up' : 'opacity-0'">
                  <div class="mb-8">
                    <div class="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl">
                  ...
                  <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <NuxtLink
                      to="/products"
                      class="group relative px-10 py-4 bg-white text-purple-600 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">查看产品</span>
                      <div class="absolute inset-0 bg-gradient-to-r from-purple-50 to-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                    <NuxtLink
                      to="/contact"
                      class="group relative px-10 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-purple-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 font-display"
                    >
                      <span class="relative z-10">定制方案</span>
                      <div class="absolute inset-0 bg-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                  </div>
                </div>
          ...
          <button
            ...
            aria-label="上一张"
          >
            <Icon name="heroicons:chevron-left" class="w-6 h-6 transition-transform duration-300 group-hover:-translate-x-1" />
          </button>
          ...
          <button
            ...
            aria-label="下一张"
          >
            <Icon name="heroicons:chevron-right" class="w-6 h-6 transition-transform duration-300 group-hover:translate-x-1" />
          </button>
          ...
          <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex space-x-3 z-30">
            <button
              ...
              :class="heroSlide === index ? 'w-10 h-3 bg-white rounded-full shadow-lg' : 'w-3 h-3 bg-white/50 rounded-full hover:bg-white/70'"
              :aria-label="`切换到第${index + 1}张`"
            >
              <span v-if="heroSlide === index" class="absolute inset-0 bg-white rounded-full animate-pulse"></span>
            </button>
          </div>
        </ClientOnly>
      </div>
    ...
    <!-- 产品展示 -->
    <section class="product-section py-20 bg-gradient-to-br from-eco-50 to-white relative overflow-hidden animate-background-shift">
      <!-- 背景装饰 -->
      <div class="absolute inset-0 opacity-5">
        <div class="parallax-element absolute top-1/4 right-1/4 w-96 h-96 bg-eco-500 rounded-full filter blur-3xl" data-speed="0.25"></div>
        <div class="parallax-element absolute bottom-1/4 left-1/4 w-96 h-96 bg-blue-500 rounded-full filter blur-3xl" data-speed="0.15"></div>
      </div>
              ...
              <div class="flex transition-transform duration-700 ease-out" :style="{ transform: `translateX(-${currentSlide * 100}%)` }" v-if="isClientInitialized">
                ...
                >
                  ...
                  <div class="lg:col-span-2 bg-gray-100 h-96 lg:h-auto relative overflow-hidden group">
                    ...
                    <div class="absolute top-6 left-6 bg-eco-600 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg flex items-center space-x-2">
                  ...
                  <div class="p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-br from-white to-gray-50">
                    <div class="mb-2">
                      <span class="text-eco-600 font-medium text-sm uppercase tracking-wider">{{ product.series || 'MZ系列' }}</span>
                    </div>
                    <h3 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 leading-tight">{{ product.name }}</h3>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm mb-8 border border-gray-100">
                      ...
                      <div class="space-y-3">
                        ...
                        >
                          ...
                          <span class="font-medium text-gray-900 text-sm bg-eco-50 px-2 py-1 rounded">{{ value }}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mb-8">
                      ...
                      <div class="flex flex-wrap gap-2">
                        <span v-for="feature in product.features || ['高效节能', '稳定可靠', '智能控制']" :key="feature" class="px-3 py-1 bg-eco-100 text-eco-700 rounded-full text-xs font-medium">
                          {{ feature }}
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div class="absolute inset-0 bg-gradient-to-r from-eco-600 to-eco-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </NuxtLink>
                  </div>
                </div>
              </div>
    ...
    <!-- 公司优势 -->
    <section class="py-20 relative overflow-hidden" style="background-image: url('https://picsum.photos/seed/mzsy-advantage/1920/1080.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
      <!-- 深色遮罩层 -->
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div class="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-full text-sm font-medium mb-6">
              我们的优势
            </div>
            ...
            <div class="space-y-8">
              <div class="advantage-card group flex items-start glow-element">
                <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 mouse-follow" data-speed="0.02">
                  <Icon name="heroicons:light-bulb" class="w-7 h-7 text-white" />
                </div>
                <div class="ml-6">
                  <h3 class="text-xl font-bold text-white mb-3 group-hover:text-blue-300 transition-colors duration-300">技术创新</h3>
                  <p class="text-gray-300 leading-relaxed">拥有多项核心技术专利，持续推动新能源技术突破，为客户提供更高效的解决方案。</p>
                </div>
              </div>

              <div class="advantage-card group flex items-start glow-element">
                <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-eco-500 to-eco-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 mouse-follow" data-speed="0.02">
                  <Icon name="heroicons:sparkles" class="w-7 h-7 text-white" />
                </div>
                <div class="ml-6">
                  <h3 class="text-xl font-bold text-white mb-3 group-hover:text-eco-300 transition-colors duration-300">绿色环保</h3>
                  <p class="text-gray-300 leading-relaxed">所有产品和技术均以环保为核心，致力于减少碳排放，推动可持续发展。</p>
                </div>
              </div>

              <div class="advantage-card group flex items-start glow-element">
                <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
                  <Icon name="heroicons:star" class="w-7 h-7 text-white" />
                </div>
                <div class="ml-6">
                  <h3 class="text-xl font-bold text-white mb-3 group-hover:text-yellow-300 transition-colors duration-300">专业服务</h3>
          ...
          <div class="relative">
            <div class="relative rounded-3xl overflow-hidden shadow-2xl bg-white/10 backdrop-blur-md p-8 border border-white/20">
              <h3 class="text-2xl font-bold text-white mb-6 text-center">为什么选择淼泽松源</h3>

              <div class="space-y-6">
                <div class="flex items-start space-x-4">
                  <div class="flex-shrink-0 w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
              ...
              <div class="mt-8 text-center">
                <div class="inline-flex items-center px-6 py-3 bg-white/20 backdrop-blur-sm text-white font-semibold rounded-full shadow-lg border border-white/30">
    ...
    <section class="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      <!-- 背景装饰 -->
      <div class="absolute inset-0 opacity-5">
        <div class="parallax-element absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500 rounded-full filter blur-3xl" data-speed="0.2"></div>
        <div class="parallax-element absolute bottom-1/4 right-1/4 w-96 h-96 bg-eco-500 rounded-full filter blur-3xl" data-speed="0.3"></div>
      </div>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <!-- 背景光效 -->
            <div class="absolute inset-0 bg-gradient-to-br from-eco-50 to-blue-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

            <!-- 图标容器 -->
            <div class="relative mb-6">
              <div class="absolute inset-0 bg-eco-100 rounded-2xl blur-xl group-hover:scale-110 transition-transform duration-500 opacity-70"></div>
              <div class="relative bg-gradient-to-br from-eco-500 to-eco-600 rounded-2xl p-4 text-white shadow-lg group-hover:shadow-2xl transition-all duration-500 transform group-hover:rotate-3 flex items-center justify-center">
            ...
            <!-- 悬浮效果 -->
            <div class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-eco-500 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-gradient-to-br from-eco-600 via-eco-700 to-blue-800 relative overflow-hidden">
      ...
      <div class="absolute inset-0 opacity-10">
        <div class="parallax-element absolute top-1/4 left-1/4 w-96 h-96 bg-white rounded-full filter blur-3xl" data-speed="0.15"></div>
        <div class="parallax-element absolute bottom-1/4 right-1/4 w-96 h-96 bg-white rounded-full filter blur-3xl" data-speed="0.25"></div>
      </div>

      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-12">
          <div class="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-full text-sm font-medium mb-4">
            我们的成就
          </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div class="stat-card text-center group">
            <div class="relative mb-4">
              <div class="absolute inset-0 bg-white/20 rounded-2xl blur-xl group-hover:scale-110 transition-transform duration-500"></div>
            ...
            <div class="mt-2 h-1 w-16 bg-white/30 rounded-full mx-auto group-hover:bg-white/60 transition-colors duration-300"></div>
          </div>
    ...
    <section class="cta-section py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      <!-- 背景装饰 -->
      <div class="absolute inset-0 opacity-5">
        <div class="parallax-element absolute top-1/3 right-1/3 w-96 h-96 bg-eco-500 rounded-full filter blur-3xl" data-speed="0.2"></div>
        <div class="parallax-element absolute bottom-1/3 left-1/3 w-96 h-96 bg-blue-500 rounded-full filter blur-3xl" data-speed="0.1"></div>
      </div>
        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              ...
              <div class="absolute inset-0 bg-eco-50 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </NuxtLink>
          </div>
